...
export default function BookingSection({ preselectedPartyType }) {
  ...
  const handleSubmit = (e) => {
    ...
    // Simulate instantaneous luxury reservation processing
    setTimeout(() => {
  ...
  return (
    <section id="dat-ban" className="py-20 sm:py-28 relative bg-[#08111c] overflow-hidden">
      {/* Ambient glow */}
      <div className="ambient-glow w-96 h-96 bg-[#cba864]/5 top-1/3 -right-20" />
      <div className="ambient-glow w-96 h-96 bg-blue-900/10 bottom-10 left-10" />
            ...
            <div className="space-y-6 pt-4 border-t border-white/10">
              ...
              <div>
                ...
                <a
                  ...
                  className="text-base font-bold text-white hover:text-[#cba864] transition-colors"
                >
                  {info.hotlineNumber}
                </a>
              ...
              <div>
                ...
                <a
                  ...
                  className="text-sm font-medium text-white hover:text-[#cba864] transition-colors"
                >
                  {info.fanpageUrl}
                </a>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 rounded-sm luxury-input text-sm bg-[#0a1523]"
                    >
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="btn-gold w-full py-4 rounded-sm text-xs sm:text-sm font-bold tracking-wider uppercase inline-flex items-center justify-center gap-2 group"
                  >
                    <span>
                      {isSubmitting
                        ? "ĐANG XỬ LÝ YÊU CẦU..."
